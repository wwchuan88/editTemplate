<template>
	<view class="home-page">
			...
			<section class="profile-section">
				<view class="profile-avatar-wrap">
					<view class="avatar-outer">
						<image class="avatar-image" mode="aspectFill" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCiDNAy1n4Q9FZpxIx1fICKTP8wT1_Vzsd_FwKZakaxE1PywCvaGcIs_b9fLbE2uPP-A_SrdgYWQLm2ni8K3mQf_-DNOniIf5z9UxFMLHwNTcbnRNmq4YX0LuTw6cUXrKeEaTR4BMb-0BAa4vHLf9QV7nwm5bVskSL4diedTlz8hAfIZMa2IfC1yONHNe2Cz9TkqpzUkAQZWDlUHyp7V8J4o38zgBx4hV_6ZUHWZyV0znAn3ksvXUXr5Eyl2XB_QW1KYz-DzzhFpbQ" />
					</view>
		...
		<nav class="bottom-nav">
			...
			<view class="nav-item" @click="switchTab('orders')">
				<text class="material-symbols-outlined">shopping_bag</text>
				<span class="nav-label">Orders</span>
			</view>
			<view class="nav-item nav-item-active" @click="switchTab('me')">
				<text class="material-symbols-outlined" style="font-variation-settings: 'FILL' 1;">person</text>
...
const portfolioItems = [
	{
		image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBYPlfnDnoWczT-qqpA41B8G7nVo_tk02W8jT8Co4Ebxnh_1qGDO6FU6x420c-UAD0wA_0bytXk5u02L1Dr-IWAgNooeZMwaq09Q0KKXtbozvTREoZmXd20c-TGUQLMxFu04KTibABx3ix6_goclBmvvuLxcS32Y_qwRvkA1yC9FEtcS7pd-oG7G560viZWlGU7w1nbJ7F5lzTe8zq8XKsnE-YXUobXcABNYf2264B5oTzog337qrLlEOyLb_lX4O7gIzfm2hJv1bE',
		title: '夏日柠黄限定',
	...
	{
		image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBnbpjxHfYr6dBZVIx8cnlos-K4vQ3aolZRfUPnGa5spje2JVRiiS10Kv67W5KQxeyqTCrDB84B2Y6Rg7nQiUQAPFe7yE-KVfE0G8iNHqgzLgeMaIwM9ZBEEDD3XTGl8-iQ5DaKLnTQJ_ygNpyJEoIiL4AG7dlQS5l7Id_ZFbmXpVhFU-awwixNPI0i9UX3Ihk728t41Jmon7nv73ECJFTlt64KegVqud6KTNaJCmDp3FRTFJ1_NChT3FXRDy3B8AEpfXxRLz2XBbg',
		title: '梦幻云朵系列',
