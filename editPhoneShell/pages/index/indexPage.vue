			...
			<section class="video-section">
				<div class="section-header">
					<div class="section-info">
						...
						<p class="section-desc">教你如何定制手机壳</p>
					</div>
					<view class="view-more" @click="handleViewMore">查看更多</view>
				</div>
				<view class="video-list">
					...
					>
						<view class="video-thumbnail-wrap">
							<image class="video-thumbnail" mode="aspectFill" :src="video.thumbnail" />
						...
						<div class="video-info">
							...
							<div class="video-stats">
								...
								<view class="stat-item">
									<text class="material-symbols-outlined">thumb_up</text>
...
const videos = [
	{
		thumbnail: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAnrGv7aK6iR_S1pL4-U0H-I8i6E7U9y9X1Y8z7G6F5E4D3C2B1A0-9876543210',
		title: '小白入门：三步拼出你的专属外壳',
		duration: '05:24',
		views: '2.8w',
		likes: '1.2k'
	},
	{
		thumbnail: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBmO9P8Q7R6S5T4U3V2W1X0Y-Z9A8B7C6D5E4F3G2H1I0_J9K8L7M6N5',
		title: '进阶指南：如何使用艺术滤镜与贴纸组合',
		duration: '08:12',
		views: '1.5w',
		likes: '856'
	},
	{
		thumbnail: 'https://lh3.googleusercontent.com/aida-public/AB6AXuC1D2E3F4G5H6I7J8K9L0M1N2O3P4Q5R6S7T8U9V0W1X2Y3Z4A5B6C7',
		title: '灵感分享：当下最火的手机壳设计趋势',
		duration: '04:45',
		views: '3.2w',
		likes: '2.4k'
	}
...
function handleViewMore() {
	uni.showToast({ title: '查看更多教程', icon: 'none' })
}
