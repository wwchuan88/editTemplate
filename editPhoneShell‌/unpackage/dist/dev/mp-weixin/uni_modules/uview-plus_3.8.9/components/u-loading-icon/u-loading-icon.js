"use strict";
const uni_modules_uviewPlus_3_8_9_components_uLoadingIcon_props = require("./props.js");
...
const _sfc_main = {
  name: "u-loading-icon",
  mixins: [uni_modules_uviewPlus_3_8_9_libs_mixin_mpMixin.mpMixin, uni_modules_uviewPlus_3_8_9_libs_mixin_mixin.mixin, uni_modules_uviewPlus_3_8_9_components_uLoadingIcon_props.props],
  data() {
    return {
  ...
  computed: {
    ...
    otherBorderColor() {
      const lightColor = uni_modules_uviewPlus_3_8_9_libs_function_colorGradient.colorGradient$1(this.color, "#ffffff", 100)[80];
      if (this.mode === "circle") {
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-e9ba237c"]]);
wx.createComponent(Component);
//# sourceMappingURL=../../../../../.sourcemap/mp-weixin/uni_modules/uview-plus_3.8.9/components/u-loading-icon/u-loading-icon.js.map
