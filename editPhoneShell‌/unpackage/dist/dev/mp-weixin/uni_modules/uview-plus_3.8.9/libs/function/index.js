...
const uni_modules_uviewPlus_3_8_9_libs_function_test = require("./test.js");
const uni_modules_uviewPlus_3_8_9_libs_function_digit = require("./digit.js");
const uni_modules_uviewPlus_3_8_9_libs_config_config = require("../config/config.js");
function range(min = 0, max = 0, value = 0) {
  return Math.max(min, Math.min(max, Number(value)));
}
function getPx(value, unit = false) {
  if (uni_modules_uviewPlus_3_8_9_libs_function_test.number(value)) {
...
function addStyle(customStyle, target = "object") {
  if (uni_modules_uviewPlus_3_8_9_libs_function_test.empty(customStyle) || typeof customStyle === "object" && target === "object" || target === "string" && typeof customStyle === "string") {
    return customStyle;
  }
  if (target === "object") {
...
function addUnit(value = "auto", unit = "") {
  if (!unit) {
    unit = uni_modules_uviewPlus_3_8_9_libs_config_config.config.unit || "px";
  }
  if (unit == "rpx" && uni_modules_uviewPlus_3_8_9_libs_function_test.number(String(value))) {
    value = value * 2;
  }
  value = String(value);
  return uni_modules_uviewPlus_3_8_9_libs_function_test.number(value) ? `${value}${unit}` : value;
}
function deepClone(obj) {
  ...
  const o = uni_modules_uviewPlus_3_8_9_libs_function_test.array(obj) ? [] : {};
  for (const i in obj) {
...
function error(err) {
  {
    common_vendor.index.__f__("error", "at uni_modules/uview-plus_3.8.9/libs/function/index.js:323", `uView提示：${err}`);
  }
}
...
function priceFormat(number, decimals = 0, decimalPoint = ".", thousandsSeparator = ",") {
  ...
  let s = "";
  s = (prec ? uni_modules_uviewPlus_3_8_9_libs_function_digit.round(n, prec) + "" : `${Math.round(n)}`).split(".");
  const re = /(-?\d+)(\d{3})/;
  while (re.test(s[0])) {
...
exports.sleep = sleep;
//# sourceMappingURL=../../../../../.sourcemap/mp-weixin/uni_modules/uview-plus_3.8.9/libs/function/index.js.map
